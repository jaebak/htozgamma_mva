...
if __name__ == '__main__':
  ...
  gbdt_classifier.fit(train_feature_array, train_hot_label_array[:,nlabels-1])

  # Train xgboost
  print("Training xgboost")
  xgbdt_classifier = xgboost.XGBClassifier(max_depth=3, n_estimators=100)
  xgbdt_classifier.fit(train_feature_array, train_hot_label_array[:,nlabels-1])
  ...
  # Save tree
  gbdt_filename = 'ntuples_mva/gbdt.root'
  ...
  # Save tree
  xgbt_filename = 'ntuples_mva/xgbdt.root'
