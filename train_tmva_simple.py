...
def train_bdt(train_filename, test_filename, tmva_filename):
  ...
  #dataloader.SetSignalWeightExpression("w_llg_mass")
...
def train_nn(train_filename, test_filename, tmva_filename):
  #bkg_chain = TChain('tree')
  ##bkg_chain.Add("ntuples/train_decorr_bak.root")
