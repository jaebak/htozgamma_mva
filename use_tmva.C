...
void use_tmva() {
  ...
  //bdt_reader->AddVariable( "photon_mva", &float_store["photon_mva"] );
  //bdt_reader->AddVariable( "min_dR", &float_store["min_dR"] );
  //bdt_reader->AddVariable( "pt_mass", &float_store["pt_mass"] );
  //bdt_reader->AddVariable( "cosTheta", &float_store["cosTheta"] );
  //bdt_reader->AddVariable( "costheta", &float_store["costheta"] );
  //bdt_reader->AddVariable( "photon_res", &float_store["photon_res"] );
  //bdt_reader->AddVariable( "photon_rapidity", &float_store["photon_rapidity"] );
  //bdt_reader->AddVariable( "l1_rapidity", &float_store["l1_rapidity"] );
  //bdt_reader->AddVariable( "l2_rapidity", &float_store["l2_rapidity"] );
  for (auto var : tmva_spectators) tmva_reader->AddSpectator(var.c_str(), &float_store[var]);
  //bdt_reader->AddSpectator( "llg_mass",  &float_store["llg_mass"] );
  //bdt_reader->AddSpectator( "w_lumi",  &float_store["w_lumi"] );
  ...
  //evaluate(tmva_reader, float_store, int_store, tmva_variables, tmva_spectators, tmva_output, label, input_test_root, input_test_tree, output_root, true);
